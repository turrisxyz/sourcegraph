...
func (r *externalServiceResolver) GrantedScopes(logger log.Logger, ctx context.Context) (*[]string, error) {
	scopes, err := repos.GrantedScopes(logger, ctx, scopeCache, r.db, r.externalService)
	if err != nil {
